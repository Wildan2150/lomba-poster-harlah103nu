      ...
      <div className="bg-nu-800 text-white rounded-3xl p-6 md:p-8 relative overflow-hidden shadow-lg mb-8">
        ...
        <div className="relative border-l-2 border-nu-600 ml-3 space-y-8 z-10">
          ...
          <div className="pl-6 relative">
            ...
            <p className="text-sm text-gray-100 mb-8 italic">
              Pantau terus informasi resmi di Instagram <span className="text-yellow-400 font-medium">@pacipnuippnugadingrejo</span>.
            </p>
          </div>
        </div>
      </div>
