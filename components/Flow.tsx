  ...
  return (
    <div className="px-6 py-16 bg-gray-900 text-white">
      <div className="mb-10 text-center">
        <h2 className="text-3xl font-bold mb-2">Alur Pendaftaran</h2>
        <p className="text-gray-400 text-base">Ikuti 4 langkah mudah ini</p>
      </div>
      ...
      <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-700 before:to-transparent">
        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-gray-800 p-4 rounded-xl border border-gray-700 shadow-sm">
            <div className="flex items-center justify-between space-x-2 mb-1">
              <div className="font-bold text-white text-base">Step 1: Berkarya</div>
            </div>
            <div className="text-gray-400 text-sm">Buat poster terbaikmu sesuai tema dan ketentuan teknis di atas.</div>
          </div>
        </div>
        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-gray-800 p-4 rounded-xl border border-gray-700 shadow-sm">
            <div className="flex items-center justify-between space-x-2 mb-1">
              <div className="font-bold text-white text-base">Step 2: Posting</div>
            </div>
            <div className="text-gray-400 text-sm mb-2">Upload di IG (No Private), Tag @pacipnuippnugadingrejo. Caption filosofis.</div>
            <div className="text-xs text-nu-400 italic">#HarlahNU2026 #PosterHarlahGadingrejo #PelajarNUBerkarya</div>
          </div>
        </div>
        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-gray-800 p-4 rounded-xl border border-gray-700 shadow-sm">
            <div className="flex items-center justify-between space-x-2 mb-1">
              <div className="font-bold text-white text-base">Step 3: Registrasi</div>
            </div>
            <div className="text-gray-400 text-sm mb-3">Isi form & upload file Hi-Res. Siapkan scan Kartu Pelajar/KTM.</div>
            <a 
              href="https://forms.gle/9Lg3htmerWNajmHz8"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-lg transition-colors shadow-lg shadow-blue-900/30"
            >
        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-gray-800 p-4 rounded-xl border border-gray-700 shadow-sm">
            <div className="flex items-center justify-between space-x-2 mb-1">
              <div className="font-bold text-white text-base">Step 4: Selesai</div>
            </div>
            <div className="text-gray-400 text-sm">Tunggu pengumuman pemenang. Berdoa ya!</div>
          </div>
        </div>
